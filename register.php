        ...
        <div class="navbar-nav ms-auto py-0">
          ...
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu m-0">
              ...
              <!-- <a href="maps.html" class="dropdown-item active">Maps</a> -->
      ...
      <div class="text-center">
        ...
        <form action="php/register-process.php" method="POST">
          <div class="form-floating mt-4 shadow-sm">
            <input name="name" type="text" class="form-control" id="floatingInput" placeholder="Your Name" required />
          ...
          <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <strong>Oops!</strong>This email address already exists
          ...
          <button type="submit" name="submit" class="btn btn-primary btn-lg w-100 mt-4">
            Sign Up
          </button>
          <a class="d-block mt-3" href="login.html">Already have an account?</a>
        </form>
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-3 col-md-6">
          ...
          <div class="position-relative mx-auto" style="max-width: 400px">
            ...
            <a href="/WEB-Project/signUp.html" type="button" class="btn btn-primary py-2 position-absolute top-0 end-0 mt-2 me-2">SignUp</a>
          </div>
        </div>
      </div>
    </div>
